...
class IssueTypeTest extends TypeTestCase
{
    ...
    protected function loadTypes()
    {
        ...
        $searchHandler = $this->getMockBuilder(
        ...
        $htmlTagProvider = $this->getMockBuilder(
        ...
        $classMetadata->expects($this->any())
            ->method('getName')
            ->will($this->returnValue('App\IssueBundle\Entity\Priority'));
    ...
    public function testSubmitValidData()
    {
        ...
        $this->assertInstanceOf('App\IssueBundle\Entity\Issue', $form->getData());
